    ...
    (
        SELECT
               ...
               CASE
                   ...
                   THEN 'TABLE/VIEW OR COLUMN MISSING'
               ...
               END AS Result,
               a.Precision ExpectedNumberPrecision,
               b.NUMERIC_PRECISION FoundNumberPrecision,
               a.Scale ExpectedNumberScale,
               b.NUMERIC_SCALE FoundNumberScale,
               a.CharaterLength ExpectedCharLength,
               b.CHARACTER_MAXIMUM_LENGTH FoundCharLength,
               a.IsNullable ExpectedIsNullable,
               b.IS_NULLABLE FoundIsNullable,
               a.DT_Preceision ExpectedDatePrecision,
               b.DATETIME_PRECISION FoundDatePrecision
        FROM
             #datavalidation a
