...
params <- list()
## connect to VDW
 # enter the name of the server where your VDW resides (may need to talk to your DBA)
params$DBServerName <- "cc-s-d05.ucdenver.pvt"
 # Enter the name of the VDW
params$DBName       <- "VDW_3_2_1_DH_0119"
params$DBUser <- ''
params$QAAlert <-F
...
tab1_loc <- run_query(paste0("select count(*) as nrows, 
	count(distinct person_id) as npats
...
#Row totals
rownames(tab_race1race2) <- tab_race1race2$RaceGroup
tab_race1race2$RaceGroup <- NULL
...
#Row totals
rownames(tab_race1race3) <- tab_race1race3$RaceGroup
tab_race1race3$RaceGroup <- NULL
...
#Row totals
rownames(tab_race1race4) <- tab_race1race4$RaceGroup
tab_race1race4$RaceGroup <- NULL
...
#Row totals
rownames(tab_race1race5) <- tab_race1race5$RaceGroup
tab_race1race5$RaceGroup <- NULL
...
#Row totals
rownames(tab_race1hispanic) <- tab_race1hispanic$RaceGroup
tab_race1hispanic$RaceGroup <- NULL
...
#Row totals
rownames(tab_race2hispanic) <- tab_race2hispanic$RaceGroup
tab_race2hispanic$RaceGroup <- NULL
...
#Row totals
rownames(tab_race3hispanic) <- tab_race3hispanic$RaceGroup
tab_race3hispanic$RaceGroup <- NULL
...
#Row totals
rownames(tab_race4hispanic) <- tab_race4hispanic$RaceGroup
tab_race4hispanic$RaceGroup <- NULL
...
#Row totals
rownames(tab_race5hispanic) <- tab_race5hispanic$RaceGroup
tab_race5hispanic$RaceGroup <- NULL
...
#Row totals
rownames(tab_race1lang) <- tab_race1lang$RaceGroup
tab_race1lang$RaceGroup <- NULL
...
#Row totals
rownames(tab_race2lang) <- tab_race2lang$RaceGroup
tab_race2lang$RaceGroup <- NULL
...
#Row totals
rownames(tab_race3lang) <- tab_race3lang$RaceGroup
tab_race3lang$RaceGroup <- NULL
...
#Row totals
rownames(tab_race4lang) <- tab_race4lang$RaceGroup
tab_race4lang$RaceGroup <- NULL
...
#Row totals
rownames(tab_race5lang) <- tab_race5lang$RaceGroup
tab_race5lang$RaceGroup <- NULL
...
```{r echo = F, include=T, echo = F, include=T, error=T}
