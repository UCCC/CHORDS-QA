...
```{r tab7.11_fig, echo = F, include=T, error=T, fig.height=5, fig.width=6.25}
...
```{r fig2, echo = F, include=T, error=T, fig.height=5, fig.width=6.25}
...
```{r fig3a, echo = F, include=T, echo = F, include=T, error=T, fig.height=5, fig.width=6.25}
...
```{r fig3b, echo = F, include=T, echo = F, include=T, error=T, fig.height=5, fig.width=6.25}
...
```{r Count of diagnoses by year and month in ambulatory encounters, echo = F, include=T, error=T, fig.height=5, fig.width=6.25}
...
```{r Count of diagnoses by year and month other encounter types, echo = F, include=T, error=T, fig.height=5, fig.width=6.25}
...
```{r Count of vital signs by year and month, echo = F, include=T, error=T, fig.height=5, fig.width=6.25}
