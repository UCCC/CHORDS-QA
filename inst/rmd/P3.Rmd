...
schema_validation_query <- paste(scan(paste0(sqlFiles, "/VDW_Schema_Validation.sql"), what = character()), collapse = ' ')#read_file(dir(sqlFiles, "VDW_Schema_Validation.sql", f=TRUE))
