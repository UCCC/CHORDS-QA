...
if (params$QAAlert == TRUE){
  missing_columnsTables$message <- paste0(missing_columnsTables$TableName, ".", missing_columnsTables$ColumnName, sep="")
  QA_Alert_Message_103_items <- paste0(missing_columnsTables$message, collapse = ', ')
...
if (params$QAAlert == TRUE){
  foundNullable_table <- data.frame(foundNullable, stringsAsFactors = FALSE)
  foundNullable_table$message <- paste0(foundNullable_table$TableName, ".", foundNullable_table$ColumnName, sep="")
  QA_Alert_Message_107_items <- paste0(foundNullable_table$message, collapse = ', ')
...
if (params$QAAlert == TRUE){
  orphan_person_ids_table <- data.frame(orphan_person_ids, stringsAsFactors = FALSE)
  orphan_person_ids_table$message <- paste0(orphan_person_ids_table$TargetTable, sep="")
  QA_Alert_Message_108_items <- paste0(orphan_person_ids_table$message, collapse = ', ')
...
if (params$QAAlert == TRUE){
  orphan_enc_ids_table <- data.frame(orphan_enc_ids, stringsAsFactors = FALSE)
  orphan_enc_ids_table$message <- paste0(orphan_enc_ids_table$TargetTable, sep="")
  QA_Alert_Message_109_items <- paste0(orphan_enc_ids_table$message, collapse = ', ')
...
if (params$QAAlert == TRUE){
  orphan_provider_ids_table <- data.frame(orphan_provider_ids, stringsAsFactors = FALSE)
  orphan_provider_ids_table$message <- paste0(orphan_provider_ids_table$TargetTable, sep="")
  QA_Alert_Message_112_items <- paste0(orphan_provider_ids_table$message, collapse = ', ')
...
WHERE  RowNum <= 50
ORDER BY CountInvalid Desc, TableName, CodeType;
")
...
if (params$QAAlert == TRUE){
  ...
  if (!rlang::is_empty(ipedei_no_principal_diag_table)){
...
if (params$QAAlert == TRUE){
  data_result_75_complete_table <- subset(data_result_75_complete, "PercentofBenchMark" < 75.0 )
  if (!rlang::is_empty(data_result_75_complete_table)){
