...
## Table 5.1 Gender Indetity Distribution 

```{r gender_identity , echo=F}
...
knitr::kable(gender_identity[c( 'Gender Identity','count','countPct')], 
            ...
            format.args = list(big.mark = ","))
```
## Table 5.2 Gender Indetity by Gender Distribution 

```{r gender_by_gender_identity , echo=F}
demographics <- "demographics"
...
tab7.13_rowCnt <- sqlQuery(sqldb,
                 paste("SELECT age, count(*) as rowCnt",
                       "FROM #encTmp10 where Race1 in ('UN') and Hispanic in ('U') GROUP BY age ",
                       sep=" "
                       )
                )
...
```{r tab7.12_disp, echo = F}
knitr::kable(tab7.13_combined[    c('ageCat', 'count','tab7.13_total.count','countPct', 'rowPct')], 
...
## Figure 4a. Count of diagnoses by year and month in ambulatory encounters , Dataset: DIAGNOSES 
...
## Figure 4b. Count of diagnoses by year and month, other encounter types , Dataset: DIAGNOSES 
...
## Figure 5. Count of vital signs by year and month, Dataset: VITAL_SIGNS
...
tab17_final2 <- qwraps2::summary_table(tab17_final, tab17_display)


tab17_final <- qwraps2::summary_table(tab17_final, tab17_display, digits = 2)
```

## Table 18: CENSUS_LOCATION Table Information
...
knitr::kable(tab18_allCounty, col.names = c("County Geocode", "Frequency County Geocode", "Percent County Geocode"), format.args = list(big.mark = ","), align='l')

knitr::kable(tab18_allAddType, col.names = c("Address Flag Type Code", "Frequency Address Type Code", "Percent Address Type Code"), format.args = list(big.mark = ","), align='l')
```
